...
# ODU Overheads Config
    ...
    # ODU_TCMi_TTI= OTN_Field_Data("    # ODU_TCMi_TTI",parent_type="ODU_TCM")
    # ODU_TCMi_BIP8= OTN_Field_Data("    # ODU_TCMi_BIP8",parent_type="ODU_TCM")
    # ODU_TCMi_BEI_BIAE= OTN_Field_Data("    # ODU_TCMi_BEI_BIAE",parent_type="ODU_TCM", num_of_bits=4)
    # ODU_TCMi_BDI= OTN_Field_Data("    # ODU_TCMi_BDI",parent_type="ODU_TCM" , num_of_bits=1)
    # ODU_TCMi_STAT= OTN_Field_Data("    # ODU_TCMi_STAT",parent_type="ODU_TCM" , num_of_bits=3)
...
# ODU_PM Config :
    ...
    ODU_PM= OTN_Field_Data("    ODU_PM",parent_type="ODU", row_num=2, column_start=9, column_end=12 ,num_of_bits=24 , inner_levels=ODU_PM_inner_levels)
...
# Frame Alignment Overheads Config :
    ...
    FA_MFAS= OTN_Field_Data("    FA_MFAS",parent_type="FA", row_num=0, column_start= 6)