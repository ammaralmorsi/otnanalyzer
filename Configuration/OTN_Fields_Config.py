...
# ODU Overheads Config
    ...
    ODU_RES1 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=0 , column_end= 1, num_of_bits=16)

    ODU_PM_TCM_DMt1 = OTN_Field_Data(parent_type="ODU_PM_TCM" , num_of_bits=1)
    ODU_PM_TCM_DMt2 = OTN_Field_Data(parent_type="ODU_PM_TCM" ,  num_of_bits=1)
    ODU_PM_TCM_DMt3 = OTN_Field_Data(parent_type="ODU_PM_TCM" , num_of_bits=1)
    ODU_PM_TCM_DMt4 = OTN_Field_Data(parent_type="ODU_PM_TCM" , num_of_bits=1)
    ODU_PM_TCM_DMt5 = OTN_Field_Data(parent_type="ODU_PM_TCM" , num_of_bits=1)
    ODU_PM_TCM_DMt6 = OTN_Field_Data(parent_type="ODU_PM_TCM" , num_of_bits=1)
    ...
    ODU_PM_TCM = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=2 , column_end=3 , inner_levels=ODU_PM_TCM_DMt_inner_levels)


    ODU_EXP1 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=3 , column_end=4)
    ODU_EXP2 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=13 , column_end = 14)
    ...
    ODU_TCM1 = OTN_Field_Data(parent_type="ODU", row_num=2, column_start=6,column_end=9 , num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
    ODU_TCM2 = OTN_Field_Data(parent_type="ODU", row_num=2, column_start=3 , column_end = 6 , num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
    ODU_TCM3 = OTN_Field_Data(parent_type="ODU", row_num=2, column_start=0 , column_end = 3 ,num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
    ODU_TCM4 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=10, column_end = 13 ,num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
    ODU_TCM5 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=7, column_end = 10,num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
    ODU_TCM6 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=4, column_end = 7 ,num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
...
# ODU_PM Config :
    ...
    ODU_RES2 = OTN_Field_Data(parent_type="ODU", row_num=3, column_start=8, column_end= 14 ,num_of_bits=48)
...
# OTU Overheads Config:
    ...
    OTU_SM = OTN_Field_Data(parent_type="OTU", row_num=0, column_start=7 , column_end=10 , num_of_bits=24)

    OTU_GCC0 = OTN_Field_Data(parent_type="OTU", row_num=0, column_start=10 , column_end=12, num_of_bits=16)
    OTU_OSMC = OTN_Field_Data(parent_type="OTU", row_num=0, column_start=12 , column_end=13)
    OTU_RES = OTN_Field_Data(parent_type="OTU", row_num=0, column_start=13 , column_end= 14)
...
# Frame Alignment Overheads Config :
    ...
    FA_FAS = OTN_Field_Data(parent_type="FA", row_num=0, column_start= 0, column_end= 6, num_of_bits=48)
