...
# ODU Overheads Config
    ...
    ODU_EXP1 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=3)
    ODU_EXP2 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=13)
    ...
    ODU_TCM1 = OTN_Field_Data(parent_type="ODU", row_num=2, column_start=6,column_end=8 , num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
    ODU_TCM2 = OTN_Field_Data(parent_type="ODU", row_num=2, column_start=3 , column_end = 5 , num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
    ODU_TCM3 = OTN_Field_Data(parent_type="ODU", row_num=2, column_start=0 , column_end = 2 ,num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
    ODU_TCM4 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=10, column_end = 12 ,num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
    ODU_TCM5 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=7, column_end = 9,num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
    ODU_TCM6 = OTN_Field_Data(parent_type="ODU", row_num=1, column_start=4, column_end = 6 ,num_of_bits=24, inner_levels= ODU_TCMi_inner_levels)
...
# OTU Overheads Config:
    ...
    OTU_SM = OTN_Field_Data(parent_type="OTU", row_num=0, column_start=7 , column_end=10 , num_of_bits=24 , inner_levels= OTU_SM_inner_levels)
