...
class TestOduFrameGenerator(unittest.TestCase):
    def test_null(self):
        ...
        otu.overheads.sm.generator = FixedValueOverheadGenerator(fixed_value=5, size=otu.overheads.sm.dimension.ncols)
        otu.get_next_frame()
        # print(odu)
    ...
    def test_prbs(self):
        ...
        otu = OtuFrameGenerator(odu_frame_generator=odu)
        otu.overheads.gcc0.generator = SweepOverheadGenerator(start=2, end=6, size=otu.overheads.gcc0.dimension.ncols)
        otu.get_next_frame()
        # print(odu)
